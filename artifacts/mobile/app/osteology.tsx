...
const IMGS: Record<string, ImageSourcePropType> = {
  skull_ant_post:  require("../assets/osteology/skull_ant_post.jpg"),
  skull_lat:       require("../assets/osteology/skull_lat.jpg"),
  skull_base:      require("../assets/osteology/skull_base.jpg"),
...
const TABS: TabData[] = [
  {
    ...
    label: "Skull",
    bones: [
      { id: "skull1", name: "Skull",          sub: "Anterior · Posterior views",       img: IMGS.skull_ant_post },
      { id: "skull2", name: "Skull",          sub: "Lateral views",                    img: IMGS.skull_lat      },
      { id: "skull3", name: "Skull Base",     sub: "Inferior · Foramina",              img: IMGS.skull_base     },
      { id: "skull4", name: "Cranial Cavity", sub: "Floor — Superior view",            img: IMGS.cranial_cavity },
      { id: "skull5", name: "Mandible",       sub: "Anterior · Lateral · Posterior",  img: IMGS.mandible       },
    ],
  },
  {
    id: "vertebrae",
    ...
    bones: [
      ...
      { id: "vert3", name: "Cervical Vertebrae", sub: "Posterolateral · Superior views",  img: IMGS.cervical },
      { id: "vert4", name: "Thoracic Vertebrae", sub: "Lateral · Posterior views",        img: IMGS.thoracic },
      { id: "vert5", name: "Lumbar Vertebrae",   sub: "Lateral · Posterior views",        img: IMGS.lumbar   },
  ...
  },
  {
    ...
    bones: [
      ...
      { id: "thor2", name: "Ribs",   sub: "Rib 1 Superior · Rib 5 views",          img: IMGS.ribs    },
    ],
  },
  {
    id: "upper",
    ...
    bones: [
      ...
      { id: "up2", name: "Scapula",       sub: "Posterior · Lateral views",              img: IMGS.scapula     },
      { id: "up3", name: "Humerus",       sub: "Anterior · Posterior views",             img: IMGS.humerus     },
      { id: "up4", name: "Radius & Ulna", sub: "Multiple views",                         img: IMGS.radius_ulna },
      { id: "up5", name: "Hand",          sub: "Dorsal view",                            img: IMGS.hand        },
    ],
  },
  {
    id: "lower",
    label: "Lower Limb",
    bones: [
      { id: "lo1", name: "Pelvis",         sub: "Anterior · Posterior views",   img: IMGS.pelvis      },
      { id: "lo2", name: "Hip Bone",       sub: "Lateral view",                 img: IMGS.hip_bone    },
      { id: "lo3", name: "Femur",          sub: "Multiple views",               img: IMGS.femur       },
      { id: "lo4", name: "Tibia & Fibula", sub: "Multiple views",               img: IMGS.tibia_fibula},
      { id: "lo5", name: "Foot",           sub: "Lateral · Medial views",       img: IMGS.foot        },
    ],
  },
];
